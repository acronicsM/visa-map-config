...
3. Обновить **`FilterSidebar`**: секции «Визовые режимы» (режим citizenship), «Безопасность», «Стоимость путешествия» (рельса «Ощущения бюджета»), «Сезонность» (месяц 1–12); снять заглушку цвета с season/budget; заглушки оставить для «Прямой рейс» / «Дальность перелёта».
